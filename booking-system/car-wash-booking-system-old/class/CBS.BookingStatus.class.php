...
class CBSBookingStatus
{
	...
	function __construct()
	{
		...
		(
			1=>array(__('Pending (new)','car-wash-booking-system')),
			2=>array(__('Processing (accepted)','car-wash-booking-system')),
			3=>array(__('Cancelled (rejected)','car-wash-booking-system')),
			4=>array(__('Completed (finished)','car-wash-booking-system')),
			5=>array(__('On hold','car-wash-booking-system')),
			6=>array(__('Refunded','car-wash-booking-system')),	
			7=>array(__('Failed','car-wash-booking-system'))
		);		
		...
		(
			1=>array(__('No synchronization','car-wash-booking-system')),
			2=>array(__('One way: from wooCommerce to plugin','car-wash-booking-system')),
			3=>array(__('One way: from plugin to wooCommerce','car-wash-booking-system'))
		);
	}
