...
?>
			...
			<?php echo $this->data['mainCSSClass']; ?> .cbs-location-list>li:hover,
			<?php echo $this->data['mainCSSClass']; ?> .cbs-location-list>li.cbs-state-selected,
			...
			<?php echo $this->data['mainCSSClass']; ?> .cbs-calendar-header .cbs-calendar-header-month-arrow-left:hover,
			<?php echo $this->data['mainCSSClass']; ?> .cbs-calendar-header .cbs-calendar-header-month-arrow-right:hover,
...
?>
			...
			<?php echo $this->data['mainCSSClass']; ?> .cbs-form .cbs-agreement-header
			{
...
?>
			...
			<?php echo $this->data['mainCSSClass']; ?> .cbs-location-list>li,			
...
?>
			<?php echo $this->data['mainCSSClass']; ?> .cbs-location-list>li,
			<?php echo $this->data['mainCSSClass']; ?> .cbs-location-drop-down>select,
			<?php echo $this->data['mainCSSClass']; ?> .cbs-vehicle-list>li,
			...
			<?php echo $this->data['mainCSSClass']; ?> .cbs-form .cbs-form-checkbox,
			<?php echo $this->data['mainCSSClass']; ?> .cbs-package-list>li>.cbs-package-duration,
			...
			<?php echo $this->data['mainCSSClass']; ?> .cbs-calendar-header .cbs-calendar-header-month-arrow-left,
			<?php echo $this->data['mainCSSClass']; ?> .cbs-calendar-header .cbs-calendar-header-month-arrow-right,
