...
class CBSGoogleCalendar
{
	...
	function insertBooking($bookingId)
	{
		...
		/*
		$bookingDescription=sprintf(__('<a href="%s" target="_blank">%s</a><br>Client: %s %s','car-wash-booking-system'),admin_url('post.php').'?post='.$bookingId.'&action=edit',$booking['post']->post_title,$booking['meta']['client_first_name'],$booking['meta']['client_second_name']);
		...
		*/
		...
		$bookingTitle=$booking['meta']['client_vehicle'];
				
		$bookingDescription=sprintf(__('<a href="%s" target="_blank">%s</a><br>Client: %s %s<br>E-mail: %s<br>Phone number: %s<br>Package name: %s<br>Sum: %s','car-wash-booking-system'),admin_url('post.php').'?post='.$bookingId.'&action=edit',$booking['post']->post_title,$booking['meta']['client_first_name'],$booking['meta']['client_second_name'],$booking['meta']['client_email_address'],$booking['meta']['client_phone_number'],$booking['meta']['package_name'],$booking['meta']['price']);
