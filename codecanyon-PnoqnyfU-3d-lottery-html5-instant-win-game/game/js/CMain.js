    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'win_panel',loop:false,volume:1, ingamename: 'win_panel'});
        s_aSoundsInfo.push({path: './sounds/',filename:'lose_panel',loop:false,volume:1, ingamename: 'lose_panel'});
        s_aSoundsInfo.push({path: './sounds/',filename:'click',loop:false,volume:1, ingamename: 'click'});
        s_aSoundsInfo.push({path: './sounds/',filename:'ball_extracted',loop:false,volume:1, ingamename: 'ball_extracted'});
        s_aSoundsInfo.push({path: './sounds/',filename:'soundtrack',loop:true,volume:1, ingamename: 'soundtrack'});
        s_aSoundsInfo.push({path: './sounds/',filename:'num_matched',loop:false,volume:1, ingamename: 'num_matched'});
        s_aSoundsInfo.push({path: './sounds/',filename:'start_extraction',loop:false,volume:1, ingamename: 'start_extraction'});
        s_aSoundsInfo.push({path: './sounds/',filename:'balls_shuffle',loop:false,volume:1, ingamename: 'balls_shuffle'});
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("slot_paytable_bg", "./sprites/slot_paytable_bg.png");

        for(var i=1; i<=TOTAL_NUMBERS; i++){
            s_oSpriteLibrary.addSprite("ball_"+i, "./sprites/balls/ball_"+i+".png");
        }
        ...
        s_oSpriteLibrary.addSprite("pick_numbers_panel", "./sprites/pick_numbers_panel.png");
